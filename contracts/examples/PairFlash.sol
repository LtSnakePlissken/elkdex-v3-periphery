...
import '@elkdex/v3-core/contracts/interfaces/callback/IElkDexV3FlashCallback.sol';
...
/// @notice An example contract using the ElkDex V3 flash function
contract PairFlash is IElkDexV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `ElkDexV3FlashCallback`
